...
export default function TiendaLanding({ profile, productos }: Props) {
  ...
  // The Globe component owns the hero motion (3D rotation + arc cycle); the
  // gold image scrub is gone. Reduce-motion is honoured at the CSS layer
  // (tienda.css neutralises animations) and inside Globe.tsx itself via the
  // GlobeStage fallback gate.
  ...
  return (
    <div ref={rootRef}>
      {/* ════════════════════════════════════════════════════════════════════
          ...
          va a la derecha (1.05fr / 0.95fr grid en desktop) y el texto a
          la izquierda. Mobile lo apila vertical (controlled by tienda.css).
          Las stats de la derecha (crédito + última compra) son placeholder
          aquí — Fase 5 las ata a Supabase.
          ════════════════════════════════════════════════════════════════════ */}
      <section className="tienda-hero">
        ...
        <div className="tienda-hero-content">
          <div className="tienda-hero-eyebrow">
            Hola · {new Intl.DateTimeFormat('es-MX', { day: 'numeric', month: 'long', year: 'numeric' }).format(new Date())}
          </div>
          ...
          <p className="tienda-hero-subtitle">
            Tienes <strong>2 pedidos en preparación</strong> y {totalProductos} productos
          ...
          <div className="tienda-hero-actions">
            <a href="#catalogo" className="tienda-cta-primary">
              ...
              <svg className="arrow" viewBox="0 0 14 14" fill="none">
                <path d="M1 7H13M13 7L7 1M13 7L7 13" stroke="currentColor" strokeWidth="0.8" />
              </svg>
            </a>
        ...
        <aside className="tienda-hero-meta">
          ...
          <div className="tienda-hero-meta-value">$ 4,800 <em>USD</em></div>
          <div className="tienda-hero-meta-divider" />
          <div className="tienda-hero-meta-label">Última compra</div>
          <div className="tienda-hero-meta-value">hace 5 días <em>$ 320</em></div>
        </aside>
      </section>
